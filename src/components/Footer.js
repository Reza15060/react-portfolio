                    ...
                    <div className="col-md-6 " >
                        <div className="div">
                            ...
                            <div className="d-flex justify-content-between px-2">
                                <FaFacebook className="footer-icons" size={40} />
                                <FaInstagram className="footer-icons" size={40}/>
                                <FaMailBulk className="footer-icons" size={40} />
                                <a href="https://www.linkedin.com/in/reza123/">
                                <FaLinkedinIn className="footer-icons" size={40} />
                                </a>
                            
                                <a href="https://github.com/Reza15060">
                                <FaGithub className="footer-icons" size={40} />
                                </a>
