...
function Home() {
  return (
    <div>
        ...
        <div className="row pt-5 justify-content-end">
          <div className="col-md-4">
            <div className="n-box2 p-5 font-bold" data-aos='fade-left'>
              <p>
                What does a React Developer do? In a nutshell,
                a React developer designs and implements user-facing features for websites and applications using React. js.
                They are known as front-end developers, a sub-group of developers that manage everything
                that users see on their web browsers or applications.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="div">
      <h3 className='font-bold text-center'>Who is Reza</h3>
        <div className="who-is-reza flex-with-center" style={{ backgroundImage: `url('/whoissathya.svg')` }} >
        <div>
             <h3>Hello Everyone </h3>
             <hr />
             <p><pre>{JSON.stringify({
                 name:"Reza Sharatz Jaman" ,
                 from : "Bangladesh" ,
                 age:null,
                 gender:"Male"
             } , null , 2)}</pre></p>
